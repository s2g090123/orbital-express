...
const i18n = require('../../../../services/language').getLocalI18n(); // grab i18n after we configured it. defaults to en locale and defaults to './locales' relative to node_modules directory to grab language json files: https://github.com/mashpie/i18n-node
...
describe('User.V1List', () => {
  ...
  beforeEach(async () => {
    ...
    try {
      ...
      await UserQueue.obliterate({ force: true }); // make sure queue is empty before each test runs
